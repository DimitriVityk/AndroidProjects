...
class FenceMgr {
    ...
    private static HashMap<String, FenceData> buildingMap = new HashMap<>();
    ...
    public void addTourPolyline(ArrayList<LatLng> latLonTour) {
        mapsActivity.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                mapsActivity.createTourPolyline(latLonTour);
            }
        });
    ...
    static FenceData getBuilding(String BuildingName) {
        FenceData fenceData = buildingMap.get(BuildingName);
        return fenceData;
    }
